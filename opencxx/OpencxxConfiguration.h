...
namespace Opencxx {
  ...
  public:
    ...
    Iterator Cc2Options() const
    {
      return Iterator(
                      std::auto_ptr<IteratorImpl>(
                                                  new IteratorImpl(cc2Options_.begin(), cc2Options_.end())
                                                  )
                      );
    }

    Iterator CppOptions() const
    {
      return Iterator(
                      std::auto_ptr<IteratorImpl>(
                                                  new IteratorImpl(cppOptions_.begin(), cppOptions_.end())
                                                  )
                      );
    }
  ...
  private:
    ...
    std::vector<std::string> cppOptions_;
